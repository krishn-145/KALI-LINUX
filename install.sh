...
# by kriahn 
#
# https://github.com/krishn/KALI-LINUX
#
...
###    ### ###     ### ########## ########### ###    ### 
                     ...
                     by </> :[KRISHN]      Termux && Termux-x11

${yellow}Kali Linux installer for Termux (proot-distro)${reset}
${green} FOLLW IN INTAGRAM : GITHUB : [KRISH]${reset}
${green}Author:${white}KRISHN [KRISHN]${reset}
${red} FOLLW IN INSTAGRAM : ur_.krishn._02${reset}
${blue} TRLGRAM : @krish18${reset}\n\n"
}
...
echo "	5) BY : KRISH [✓]"
echo ""
echo "	6) TELEGRAM : @krishn18"
echo ""
echo "	7) INSTAGRAM : ur_.kriahn._02"
